...
CREATE TABLE `primary_details` (
  ...
  `stu_admissionnumber` varchar(45) NOT NULL,
  `p_standards` int DEFAULT NULL,
  `p_country` varchar(45) DEFAULT NULL,
  `p_state` varchar(45) DEFAULT NULL,
  `p_district` varchar(45) DEFAULT NULL,
  `p_city` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `for_primary_idx` (`stu_admissionnumber`),
  CONSTRAINT `for_primary` FOREIGN KEY (`stu_admissionnumber`) REFERENCES `student_details` (`stu_admissionnumber`) ON DELETE CASCADE ON UPDATE CASCADE
